  ...
  return (
    <div className={styles.me}>
      <div className={styles.header}>
        ...
        <i style={{color: user.gender && gender_map[user.gender].color}} className={`iconfont ${user.gender && gender_map[user.gender].icon}`} />
      </div>
      <div className={styles.me_avatar}>
        <Avatar src={user.avatar_url} title={user.nick_name} />
      </div>
      <div className={styles.me_info}>
        <p className={styles.nick_name}>{user.nick_name}<span style={{color: color_map['朋辈辅导员'].color, background: color_map['朋辈辅导员'].background}}>辅导员</span></p>
